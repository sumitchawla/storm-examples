...
//
//    public static void main(String[] args){
//        String topic = "dev.activity.log";
//        String zoo = "10.1.3.78:2181,10.1.3.79:2181,10.1.3.80:2181";
//        String consumer = "consumer_t1" + topic;
//        String kafka_offset_dir = "/offset/" + consumer;
//
//
//
//        //Utils.sleep(50000);
//
//
//        TridentKafkaConfig tridentKafkaConfig = new TridentKafkaConfig(new ZkHosts(zoo),topic,consumer);
//        tridentKafkaConfig.startOffsetTime = -2;
//        tridentKafkaConfig.scheme = new SchemeAsMultiScheme(new StringScheme());
//
//        TransactionalTridentKafkaSpout t_kafkaSpout = new TransactionalTridentKafkaSpout(tridentKafkaConfig);
//
//        TridentTopology topology = new TridentTopology();
//        TridentState state = topology.newStaticState(new StateUpdaterFactory());
//        TridentState wordCounts =
//                topology.newStream("activity-events", t_kafkaSpout)
//                        .name("EventsStream")
//                        .each(new Fields("str"), new ExtractEvent(), new Fields("event", "user_id", "tenant_id", "tenant_alias", "time_inserted"))
//                        .name("Filter")
//                        .stateQuery(state, new Fields("tenant_id"), new MapGet(), new Fields("count"))
//                        .groupBy(new Fields("tenant_alias"))
//                        .aggregate(new Fields("event", "user_id", "tenant_id", "tenant_alias", "time_inserted"), new VoteCountAggregator(), new Fields("count"))
//                        .name("CountAggregator")
//                        .partitionPersist(new StateUpdaterFactory(), new Fields("tenant_alias", "count"), new StateUpdater())
//                        //.persistentAggregate(new MemoryMapState.Factory(), new Fields( "event", "user_id", "time_inserted") ,new Count(), new Fields("count"))
//                        //.parallelismHint(100)
//                        ;
//
//
...
////                .each(new Fields("args"), new WordSplit(), new Fields("event"))
////                .groupBy(new Fields("event"))
////                .stateQuery(wordCounts, new Fields("event"), new MapGet(), new Fields("count"))
////                .each(new Fields("count"), new FilterNull());
////        //.aggregate(new Fields("count"), new Sum(), new Fields("sum"));
////
////
////        ConfigData conf = new ConfigData();
////        conf.put(ConfigData.DRPC_PORT, 3772);
////        LocalCluster cluster = new LocalCluster();
////
////
////
...
////        for (int i = 0; i < 1000; i++) {
////            System.out.println(drpc.state);
////            System.out.println(drpc.execute("words", "xhome mycompany"));
////            Utils.sleep(10000);
////        }
////        cluster.shutdown();
////        drpc.shutdown();
...
//
//
//        ArrayList<String> drpcServer =  new ArrayList<String>();
//        drpcServer.add("10.1.3.78");
//
//        Config conf = new Config();
//        conf.put(Config.NIMBUS_HOST, "10.1.3.80");
//        conf.put(Config.DRPC_SERVERS, drpcServer);
//        conf.put(Config.DRPC_INVOCATIONS_PORT,3773);
//
//        conf.setDebug(true);
//        Map storm_conf = Utils.readStormConfig();
//        storm_conf.put("nimbus.host", "10.1.3.80");
//        storm_conf.put("drpc.servers",drpcServer);
//        storm_conf.put("drpc.invocations.port",3773);
//
//       // Nimbus.Client client = NimbusClient.getConfiguredClient(storm_conf)
//       //         .getClient();
//        String inputJar = "/Users/sumitc/Programs/git/java/sdc/storm/target/storm-1.0-SNAPSHOT-jar-with-dependencies.jar";
//        //System.out.println(storm_conf);
//
//        try {
//            String topologyName = "tridentuserlogins";
//            NimbusClient nimbus = new NimbusClient(storm_conf, "10.1.3.80",  6627);
...
//
//            Nimbus.Client nimbusClient =  nimbus.getClient();
//
//            try {
//                nimbusClient.killTopology(topologyName);
//                Utils.sleep(30000);
//            } catch (Exception e) {
//
//            }
//            nimbusClient.submitTopology(topologyName,
//                    uploadedJarLocation, jsonConf, topology.build());
//
